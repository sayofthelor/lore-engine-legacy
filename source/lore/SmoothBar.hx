 ...
 */
class SmoothBar extends FlxSprite
{
	/**
    ...
    private var _lerp:Bool = true;
    private var _lerpValue:Float = 0;
	 ...
	 */
	public function createFilledBar(empty:FlxColor, fill:FlxColor, showBorder:Bool = false, border:FlxColor = FlxColor.WHITE):SmoothBar
	{
	 ...
	 */
	public function createColoredEmptyBar(empty:FlxColor, showBorder:Bool = false, border:FlxColor = FlxColor.WHITE):SmoothBar
	{
		if (FlxG.renderTile)
		{
	 ...
	 */
	public function createColoredFilledBar(fill:FlxColor, showBorder:Bool = false, border:FlxColor = FlxColor.WHITE):SmoothBar
	{
		if (FlxG.renderTile)
		{
	...
	public function createGradientBar(empty:Array<FlxColor>, fill:Array<FlxColor>, chunkSize:Int = 1, rotation:Int = 180, showBorder:Bool = false,
			border:FlxColor = FlxColor.WHITE):SmoothBar
	{
	...
	public function createImageBar(?empty:FlxGraphicAsset, ?fill:FlxGraphicAsset, emptyBackground:FlxColor = FlxColor.BLACK,
			fillBackground:FlxColor = FlxColor.LIME):SmoothBar
	{
	 ...
	 * @return	This FlxBar object with generated image for background rendering.
	 */
	public function createImageEmptyBar(?empty:FlxGraphicAsset, emptyBackground:FlxColor = FlxColor.BLACK):SmoothBar
	{
		if (empty != null)
		{
	 ...
	 * @return	This FlxBar object with generated image for rendering actual values.
	 */
	public function createImageFilledBar(?fill:FlxGraphicAsset, fillBackground:FlxColor = FlxColor.LIME):SmoothBar
	{
		if (fill != null)
		{
	...
	public function updateFilledBar():Void
	{
		...
		var fraction:Float = (_lerpValue - min) / range;
